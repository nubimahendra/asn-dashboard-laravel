...
<div class="container mx-auto px-10 py-8">
                ...
                <div class="flex items-center gap-2 mt-1">
                    <p class="text-gray-500 dark:text-gray-400 flex items-center">
                        @if(isset($filterOpd) && $filterOpd) 
                            <span class="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-xs font-semibold px-2.5 py-0.5 rounded mr-2">FILTERED</span> {{ $filterOpd }} 
                        @else 
                            Pemerintah Kabupaten Blitar 
                        @endif
                    </p>
                    <span class="text-gray-300 dark:text-gray-600">|</span>
                    <span class="text-xs text-gray-400 dark:text-gray-500" title="Last Synced"><svg class="w-3 h-3 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg> Updated: {{ $lastSync ?? 'N/A' }}</span>
                </div>
            </div>
        </div>
        <div class="flex items-center gap-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 lg:col-span-2"> <h3 class="text-lg font-bold text-gray-700 dark:text-gray-200 mb-4"> @if(isset($filterOpd) && $filterOpd) Statistik Unit Kerja Ini @else Top 10 Unit Kerja / OPD @endif </h3> <div id="chart-opd"></div> </div>
    </div>
