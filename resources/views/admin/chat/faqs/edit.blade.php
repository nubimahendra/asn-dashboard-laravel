...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center gap-2 mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit FAQ</h1>
        </div>

        <div class="max-w-3xl bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border-t-4 border-blue-500">
            <form action="{{ route('admin.chat.faqs.update', $faq->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" id="keywords" name="keywords" value="{{ old('keywords', $faq->keywords) }}" required
                ...
                <div>
                    ...
                    <textarea id="answer" name="answer" rows="5" required
                        class="w-full px-4 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 transition-all">{{ old('answer', $faq->answer) }}</textarea>
                ...
                <div class="flex items-center">
                    ...
                    <label for="is_active" class="ml-2 block text-sm text-gray-900 dark:text-gray-100">Aktif (Tampilkan di
                        Chatbot)</label>
                </div>
